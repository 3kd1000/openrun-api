...
-- 2. Schedule 테이블에 테스트 일정 추가 (과거 5개, 미래 10개)
-- 모든 일정은 club_id = 1 (오픈런 클럽) 고정
...
(1, '실버 A코트', DATE_TRUNC('day', CURRENT_TIMESTAMP - INTERVAL '5 days') + TIME '14:00:00', 8, 4, 22000, NULL, CURRENT_TIMESTAMP - INTERVAL '5 days', CURRENT_TIMESTAMP - INTERVAL '5 days'),
(1, '실버 B코트', DATE_TRUNC('day', CURRENT_TIMESTAMP - INTERVAL '4 days') + TIME '10:00:00', 10, 10, 30000, '주말 특별 경기', CURRENT_TIMESTAMP - INTERVAL '4 days', CURRENT_TIMESTAMP - INTERVAL '4 days'),
(1, '브론즈 1번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP - INTERVAL '3 days') + TIME '18:00:00', 6, 5, 18000, NULL, CURRENT_TIMESTAMP - INTERVAL '3 days', CURRENT_TIMESTAMP - INTERVAL '3 days');
...
(1, '실버 A코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '4 days') + TIME '14:00:00', 8, 9, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '실버 B코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '5 days') + TIME '10:00:00', 10, 10, 30000, '주말 특별 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '실버 C코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '6 days') + TIME '08:00:00', 6, 8, 20000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '브론즈 1번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '7 days') + TIME '08:00:00', 6, 5, 18000, '다음주 월요일', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '브론즈 2번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '8 days') + TIME '14:00:00', 8, 7, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '브론즈 3번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '9 days') + TIME '10:00:00', 10, 9, 28000, '다음주 주말 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
