...
INSERT INTO schedule (club_id, court_name, scheduled_at, max_capacity, current_participants, cost, description, created_at, updated_at) VALUES
(1, '골드 1번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '1 day') + TIME '08:00:00', 8, 2, 25000, '주중 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '골드 2번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '2 days') + TIME '10:00:00', 6, 0, 20000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '골드 3번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '3 days') + TIME '18:00:00', 8, 1, 25000, '수요일 저녁 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '실버 A코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '4 days') + TIME '14:00:00', 8, 3, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '실버 B코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '5 days') + TIME '10:00:00', 10, 0, 30000, '주말 특별 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '실버 C코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '6 days') + TIME '08:00:00', 6, 2, 20000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, '브론즈 1번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '7 days') + TIME '08:00:00', 6, 1, 18000, '다음주 월요일', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, '브론즈 2번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '8 days') + TIME '14:00:00', 8, 4, 22000, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, '브론즈 3번 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '9 days') + TIME '10:00:00', 10, 0, 28000, '다음주 주말 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '골드 VIP 코트', DATE_TRUNC('day', CURRENT_TIMESTAMP + INTERVAL '10 days') + TIME '06:00:00', 4, 0, 50000, 'VIP 프라이빗 경기', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
