...
export const Trash2Icon: React.FC<IconProps> = ({
  size = 20,
  color = 'currentColor',
  className = ''
}) => (
...
// 메달 아이콘 (순위용) - Outlined 스타일
export const MedalIcon: React.FC<IconProps & { rank?: 1 | 2 | 3 }> = ({
  size = 20,
  color = 'currentColor',
  className = '',
  rank = 1
  ...
  return (
    ...
    >
      {/* 리본 */}
      <path d="M7.21 15 2.66 7.14a2 2 0 0 1 .13-2.2L4.4 2.8A2 2 0 0 1 6 2h12a2 2 0 0 1 1.6.8l1.6 2.14a2 2 0 0 1 .14 2.2L16.79 15" stroke={medalColor}></path>
      {/* 메달 원형 */}
      <circle cx="12" cy="17" r="5" stroke={medalColor}></circle>
      {/* 순위 숫자 대신 심플한 라인 */}
      <path d="M12 14v6" stroke={medalColor}></path>
    </svg>
  );
};
